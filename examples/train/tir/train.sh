set -x
train_data=[$(pwd)/data/NuminaMath-TIR/NuminaMath-TIR_train.parquet]
val_data=[$(pwd)/data/NuminaMath-TIR/NuminaMath-TIR_test.parquet]
model_name=/home/projects/polyullm/yuyang/model_weights/Qwen-2.5-3B-TIR-grpo
...
ray start --head --node-ip-address=localhost --port=6379 --num-cpus 16 --num-gpus 2 --temp-dir /home/projects/polyullm/yuyang/tmp/ray --memory 10000000000 --object-store-memory 5000000000
...
tool_server_url=http://cp2-dgx-001:15432/run_code
